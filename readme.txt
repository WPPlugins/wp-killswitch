...
WP Killswitch lets you non-destructively white out a difficult client's website while this plugin is active.

== Description ==

WP Killswitch lets you non-destructively white out a difficult client's website while this plugin is active. It is suggested that this plugin should only be used as a last resort when negotiations with a particularly difficult client fail.
